...
#
# Description: Generates the analysis data to be used to evaluate states
# staggered NCA bans. This data will be used to generate summary statistics, 
# plot raw means, and run the CS DID analysis.
#
# Dependencies:  
#
# Output:
