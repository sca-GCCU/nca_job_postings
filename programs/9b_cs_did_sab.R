...
# ----------------------------- LOAD DATA --------------------------------------
df_soc <- read_csv("data/analysis-data/agg2_sab_analysis.csv")
...
ggsave(
  "output/figures/csdid_cohort_tot_post_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_tot_post_sab.pdf",
  csdid_es_tot_post,
  width = 7,
  height = 5,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_exp_sab.pdf",
  csdid_cohort_exp,
  width = 8,
  height = 8,
  units = "in"
...
ggsave(
  "output/figures/csdid_es_exp_sab.pdf",
  csdid_es_exp,
  width = 7,
  height = 5,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_exp_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_exp_share_sab.pdf",
  csdid_es_exp_share,
  height = 5,
  width = 7,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_exp_ave_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_exp_ave_sab.pdf",
  csdid_es_exp_ave,
  height = 5,
  width = 7,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_bachelor_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_bachelor_sab.pdf",
  csdid_es_bachelor,
  height = 5,
  width = 7,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_bachelor_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_bachelor_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_cohort_fulltime_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_fulltime_sab.pdf",
  csdid_es_fulltime,
  height = 5,
  width = 7,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_fulltime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_fulltime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_cohort_parttime_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_parttime_sab.pdf",
  csdid_es_parttime,
  height = 5,
  width = 7,
  units = "in"
...
ggsave(
  "output/figures/csdid_cohort_parttime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_parttime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_tot_post_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_tot_post_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_exp_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_exp_sab.pdf",
  csdid_es_cond_exp,
  width = 7,
  height = 5,
  units = "in"
...
ggsave(
  "output/figures/csdid_cond_cohort_exp_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_exp_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_exp_ave_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_exp_ave_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_bachelor_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_bachelor_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_bachelor_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_bachelor_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_fulltime_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_fulltime_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_fulltime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_fulltime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_parttime_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_parttime_sab.pdf",
...
ggsave(
  "output/figures/csdid_cond_cohort_parttime_share_sab.pdf",
...
ggsave(
  "output/figures/csdid_es_cond_parttime_share_sab.pdf",
