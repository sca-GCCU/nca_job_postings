...
table_sumstat_outcomes <- sumtab_out_final %>%
  ...
  footnote(
    ...
    general = "Notes: This table reports the pre-ban means and standard deviations of key variables from the occupation-by-state-by-date-level aggregation of the Lightcast job-postings data.",
    threeparttable = TRUE
  ) 
